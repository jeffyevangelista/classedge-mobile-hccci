      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="w-full max-w-lg mx-auto">
          <View className="mb-5 gap-3">
            ...
            <Dialog.Description>
              Your offline session ends today. Reconnect to the internet now to
              keep your unsynced changes from being lost.
            </Dialog.Description>
            <AppText className="text-xs text-muted">
              You can keep working, but anything you change after the session
              expires may not be uploaded.
            </AppText>
          </View>
